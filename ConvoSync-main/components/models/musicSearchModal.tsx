...
import ICON from '../../public/m.json';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { Disc2, Disc3, Music2 } from 'lucide-react';
  ...
  return (
    <>
      <Dialog open={isModelOpen} onOpenChange={onClose}>
        <DialogContent
          className={cn(
            "bg-white  bg-[url('/bb.jpg')]  text-black pb-6 overflow-hidden ",
            mLink && "p-0"
          )}
        >
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 ">
              ...
              <div className="flex justify-center items-center  flex-col ">
                ...
                <ScrollArea>
                <p className="py-2 max-h-60 px-3 rounded-sm bg-green-50">{result}</p>
                </ScrollArea>
              </div>
            </form>
          </Form>
