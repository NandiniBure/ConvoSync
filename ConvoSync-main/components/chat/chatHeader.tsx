import { AtSign, VenetianMask,Bot, Hash, Map, Menu, Music, Music2 } from "lucide-react";
...
export const ChatHeader = async ({
  ...
  if (type === "conversation") {
    ...
    if (finalMessage) {
      AiQueryRaw = finalMessage + `end Here ${profile?.name} in myself `;
      AiQ = finalMessage;
      AiQuery =
        "suggest me a bollywood hindi song based on my mood by analysing the given chat : " +
        finalMessage +
