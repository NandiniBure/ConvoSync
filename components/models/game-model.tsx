    ...
    <>
      ...
      />
          ...
          <DialogHeader className="pt-4 px-6 text-white text-2xl font-mono  font-bold  uppercase  ">
               <h1 
                onClick={() => onOpen('selfgameModel')}
               className="hover:text-lime-400">Single Player</h1>
               <h1 
                onClick={() => onOpen('computergameModel')}
               className="hover:text-lime-400"> Play with computer</h1>
               <h1
                onClick={() => onOpen('doublegameModel')}
                className="hover:text-lime-400"> Play with a Friend </h1>
          </DialogHeader>
        </DialogContent>
      </Dialog>
    </>
